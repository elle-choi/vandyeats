...
import { db } from "../firebase"; // Adjust the path to your actual Firebase config file


const Home = () => {
  const navigate = useNavigate();
  const [postList, setPostList] = useState([]); // Correctly named state for storing posts
  const postsCollectionRef = collection(db, "posts"); // Correctly named Firestore collection reference

  useEffect(() => {
    const getBlogs = async () => {
      const data = await getDocs(postsCollectionRef); // Use the correctly named reference
      setPostList(data.docs.map((doc) => ({ ...doc.data(), id: doc.id }))); // Use setPostList to update the state
    };
          ...
          <div className='flex flex-col flex-grow mb-4 '>
            <div className='ml-10 flex items-center my-3'>
              ...
              <div className='w-16 h-16 flex justify-center items-center'>
                <svg className='w-12 h-12' fill="#718096" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" enable-background="new 0 0 50 50">
              ...
              <Link to="/edit-profile" className='text-[#718096] font-bold'>Edit Profile</Link>
            </div>
            ...
            <div class='ml-10 flex items-center my-3'>
              ...
              <Link to="/saved-blogs" className='text-[#718096] font-bold'>Saved Blogs</Link>
            </div>
            <div class='ml-10 flex items-center my-3'>
              <div class='w-16 h-16 flex justify-center items-center'>
              ...
              <Link to="/security" className='text-[#718096] font-bold'>Security</Link>
            </div>
            <div class='ml-10 flex items-center my-3'>
              {/* settings image */}
              <div class='w-16 h-16 flex justify-center items-center'>
              ...
              <Link to="/help" className='text-[#718096] font-bold'>Help</Link>
            </div>
          </div>
        ...
        <div class='w-9/12 flex flex-col flex-grow'>
          ...
          <div class="w-full h-56">
            ...
            <div class=" h-1/4 w-full flex justify-end ">
              ...
              <button onClick={handleLogout} className="bg-[#212121] text-white font-bold text-xs mb-20 mr-3" type="button">SignOut</button>
              </div>
